...
namespace NinjaGame.Graphics2D.Assets
{
    public class Sprite : Image
    {
        ...
        public Sprite(Texture2DAsset texture2DAsset, Vector2 sourcePosition, Vector2 sourceDimensions, Color color, Vector2 positionOffset, Vector2 dimensions, int rows, int columns, int frameTime = -1, bool looping = true, bool enabled = true, bool visible = true)
        ...
        {
            return new Sprite(_texture2DAsset, _sourceRectangle.GetPosition(), _sourceRectangle.GetDimensions(), _color, _positionOffset, _dimensions, _rows, _columns, _frameTime, _looping, _enabled, _visible);
        }
    }
}